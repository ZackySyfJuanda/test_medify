...
Route::get('/master-items', [App\Http\Controllers\MasterItemsController::class, 'index'])->name('get-master-item');
...
//route route kategori
Route::get('/kategori-items', [App\Http\Controllers\KategoriItemController::class, 'index'])->name('get-kategori-item');
...
Route::get('/kategori-items/update-random-data', [App\Http\Controllers\KategoriItemController::class, 'updateRandomData']);
