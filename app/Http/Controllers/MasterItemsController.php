...
class MasterItemsController extends Controller
{
    ...
    public function formView($method, $id = 0)
    {
        ...
        $data['item'] = $item;
        $data['method'] = $method;
        $data['kategoris'] = KategoriItem::all();
    ...
    public function formSubmit(Request $request, $method, $id = 0)
    {
        ...
        $data_item->foto = $request->file('foto')->store('masters-item', 'public');
        ...
        if ($method == 'new') {
            $data_item->kategori_items()->attach($request->kategori);
        } else {
            $data_item->kategori_items()->sync($request->kategori);
        }
